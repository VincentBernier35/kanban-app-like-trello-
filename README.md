...
- Créer un nouveau tag. X
- Modifier un tag.
- Supprimer un tag.
- Associer un tag à une carte. X
...
- Pour retrouver l'id de la liste depuis son l'élément HTML correspondant, utilise `element.getAttribute('data-list-id')`.
